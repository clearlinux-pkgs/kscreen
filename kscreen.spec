...
Version  : 5.26.3
Release  : 74
URL      : https://download.kde.org/stable/plasma/5.26.3/kscreen-5.26.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.3/kscreen-5.26.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.3/kscreen-5.26.3.tar.xz.sig
...
%prep
%setup -q -n kscreen-5.26.3
cd %{_builddir}/kscreen-5.26.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667935719
mkdir -p clr-build
pushd clr-build
