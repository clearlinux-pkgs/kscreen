...
Source0  : https://download.kde.org/stable/plasma/5.18.0/kscreen-5.18.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.18.0/kscreen-5.18.0.tar.xz.sig
...
%prep
%setup -q -n kscreen-5.18.0
cd %{_builddir}/kscreen-5.18.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581441895
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kscreen-5.18.0/COPYING %{buildroot}/usr/share/package-licenses/kscreen/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kscreen-5.18.0/COPYING.LGPL %{buildroot}/usr/share/package-licenses/kscreen/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
