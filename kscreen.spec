...
Source0  : https://download.kde.org/stable/plasma/5.27.1/kscreen-5.27.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.1/kscreen-5.27.1.1.tar.xz.sig
...
%prep
%setup -q -n kscreen-5.27.1.1
cd %{_builddir}/kscreen-5.27.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677183452
mkdir -p clr-build
pushd clr-build
...
%files locales -f kcm_kscreen.lang -f kscreen.lang -f kscreen_common.lang -f plasma_applet_org.kde.kscreen.lang
%defattr(-,root,root,-)
