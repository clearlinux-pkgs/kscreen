...
Source0  : https://download.kde.org/stable/plasma/5.26.4/kscreen-5.26.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.4/kscreen-5.26.4.tar.xz.sig
...
%prep
%setup -q -n kscreen-5.26.4
cd %{_builddir}/kscreen-5.26.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669814987
mkdir -p clr-build
pushd clr-build
