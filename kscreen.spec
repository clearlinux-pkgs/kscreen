...
Source0  : https://download.kde.org/stable/plasma/5.27.3/kscreen-5.27.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.3/kscreen-5.27.3.tar.xz.sig
...
%prep
%setup -q -n kscreen-5.27.3
cd %{_builddir}/kscreen-5.27.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679508362
mkdir -p clr-build
pushd clr-build
