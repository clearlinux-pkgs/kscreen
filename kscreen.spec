...
Source0  : https://download.kde.org/stable/plasma/6.3.5/kscreen-6.3.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.5/kscreen-6.3.5.tar.xz.sig
...
%setup -q -n kscreen-6.3.5
cd %{_builddir}/kscreen-6.3.5
pushd ..
cp -a kscreen-6.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747097164
mkdir -p clr-build
pushd clr-build
