...
Version  : 5.23.4
Release  : 57
URL      : https://download.kde.org/stable/plasma/5.23.4/kscreen-5.23.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.4/kscreen-5.23.4.tar.xz
...
%prep
%setup -q -n kscreen-5.23.4
cd %{_builddir}/kscreen-5.23.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638353061
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kscreen-5.23.4/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kscreen/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kscreen-5.23.4/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kscreen/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kscreen-5.23.4/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kscreen/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/kscreen-5.23.4/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kscreen/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/kscreen-5.23.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kscreen/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kscreen-5.23.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kscreen/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
