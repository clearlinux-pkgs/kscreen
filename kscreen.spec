...
Source0  : https://download.kde.org/stable/plasma/6.0.3/kscreen-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/kscreen-6.0.3.tar.xz.sig
...
%prep
%setup -q -n kscreen-6.0.3
cd %{_builddir}/kscreen-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711666786
mkdir -p clr-build
pushd clr-build
