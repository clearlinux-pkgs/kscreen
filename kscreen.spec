...
Version  : 5.19.1
Release  : 38
URL      : https://download.kde.org/stable/plasma/5.19.1/kscreen-5.19.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.19.1/kscreen-5.19.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.19.1/kscreen-5.19.1.tar.xz.sig
...
%prep
%setup -q -n kscreen-5.19.1
cd %{_builddir}/kscreen-5.19.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592335831
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kscreen-5.19.1/COPYING %{buildroot}/usr/share/package-licenses/kscreen/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kscreen-5.19.1/COPYING.LGPL %{buildroot}/usr/share/package-licenses/kscreen/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
