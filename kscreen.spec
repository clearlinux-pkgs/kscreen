...
Version  : 6.0.0
Release  : 91
URL      : https://download.kde.org/stable/plasma/6.0.0/kscreen-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.0/kscreen-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.0/kscreen-6.0.0.tar.xz.sig
...
%prep
%setup -q -n kscreen-6.0.0
cd %{_builddir}/kscreen-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709394762
mkdir -p clr-build
pushd clr-build
